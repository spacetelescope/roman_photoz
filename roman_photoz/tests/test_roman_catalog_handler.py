...
class TestRomanCatalogHandler:
    ...
    def test_init_filter_list_none(self):
        ...
        with patch('roman_photoz.roman_catalog_handler.default_roman_config') as mock_config:
            mock_config.get.return_value = None
            with pytest.raises(ValueError, match="Filter list not found in default config file"):
                RomanCatalogHandler()
    ...
    def test_format_catalog(self, roman_catalog_handler, mock_catalog_data):
        ...
        assert roman_catalog_handler.catalog['zspec'][1] == mock_catalog_data['zspec'][1]
    ...
    def test_process(self, mock_format_catalog, mock_read_catalog, roman_catalog_handler, mock_catalog_data):
